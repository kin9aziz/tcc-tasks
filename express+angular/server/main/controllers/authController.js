...
function validateSignupForm(payload) {
  ...
  let message = '';
  if (!payload || typeof payload.email !== 'string' || !(validations.email.regex.value).test(payload.email.trim())) {
    isFormValid = false;
    errors.email = validations.email.regex.message;
  }

  if (!payload || typeof payload.password !== 'string' || payload.password.trim().length < validations.password.minLength.value) {
    isFormValid = false;
